...
const LoginPage = () => {
  ...
  const azureLogoutUrl = `https://login.microsoftonline.com/ca56a4a5-e300-406a-98ff-7e36a0baac5b/oauth2/v2.0/logout?post_logout_redirect_uri={https://dev.ulm.metlife.com.bd}`;
